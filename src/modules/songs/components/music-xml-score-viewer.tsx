...
>(function MusicXmlScoreViewer(
  ...
  const [sideMargin, setSideMargin] = useState(DEFAULT_SIDE_MARGIN);
    ...
    async function renderScore() {
      ...
      try {
        ...
        osmd.EngravingRules.PageLeftMargin =
          appliedSideMargin / OSMD_UNIT_IN_RENDER_PIXELS;
        osmd.EngravingRules.PageRightMargin =
          appliedSideMargin / OSMD_UNIT_IN_RENDER_PIXELS;
              ...
              <div className="song-score-viewer__display-fields">
                ...
                <label className="song-score-viewer__field">
                  ...
                  <input
                    ...
                    min="0"
                    onChange={(event) => {
                      setSideMargin(Number(event.target.value));
                    }}
                    step="5"
                    type="range"
                    value={sideMargin}
